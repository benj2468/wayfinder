...
use wayfinder_protos::service::{
    InterfaceThroughputData, LinkQualityEntryData, NodeMetricsData, OgmScheduleEntryData,
    RouteResolutionData, RoutingEntryData, TableOccupancyData, WayfinderDataProvider,
    WayfinderService,
};
